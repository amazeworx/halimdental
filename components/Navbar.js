...
const navigation = [
  ...
  {
    name: 'Credentials', href: '#', current: false, submenu: [
            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-between">
                <div className="flex items-center">
                  <Link href="/">
                    <a className="block mr-4"><img className="h-10 lg:h-14 mr-auto" src="/logo-halimdental.svg" /></a>
                  </Link>
                </div>
              ...
              <ul className="text-center">
                ...
                <li className="relative has-submenu py-3"><span className={`navbar-link inline-block text-lg uppercase`}>Credentials</span>
                  <ul className="submenu pt-1">
                    <li className="py-1"><Link href="/credentials/himawan-halim"><a className={`navbar-link block text-base uppercase hover:text-brand ${router.pathname == '/credentials/himawan-halim' ? 'active' : ''}`}>Himawan Halim</a></Link></li>
                    <li className="py-1"><Link href="/credentials/ivan-halim"><a className={`navbar-link block text-base uppercase hover:text-brand ${router.pathname == '/credentials/ivan-halim' ? 'active' : ''}`}>Ivan A Halim</a></Link></li>
                  </ul>
                </li>
                <li className="py-3"><Link href="/services"><a className={`navbar-link block text-lg uppercase hover:text-brand ${router.pathname == '/services' ? 'active' : ''}`}>Services</a></Link></li>
                <li className="py-3"><Link href="/contact-us"><a className={`navbar-link block text-lg uppercase hover:text-brand ${router.pathname == '/contact-us' ? 'active' : ''}`}>Contact Us</a></Link></li>
              </ul>
            </div>
          </Disclosure.Panel>
        </>
